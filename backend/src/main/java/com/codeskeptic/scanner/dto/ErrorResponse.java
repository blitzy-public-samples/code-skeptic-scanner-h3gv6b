 ...
 *
 * <p>The retired Python tree emitted this shape from **eleven** branches carrying **ten** distinct
 * message literals between them — the two tweet branches share one: the two global handlers at
 ...
 *
 * <p>This record declares no message text of its own; each literal lives at its throwing site under
 * {@code com.codeskeptic.scanner.exception} — DL-212.
 *
