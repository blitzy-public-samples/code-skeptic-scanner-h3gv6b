 ...
 *
 * <p>A two-key envelope: {@code responses} and {@code pagination}, in the declaration order of the
 * source dictionary ({@code backend/app/api/responses.py:L18-19}). Keys are snake_case at both
 * levels — DL-022.
 *
 ...
 * to 10 ({@code backend/app/api/responses.py:L12}). {@code service/ResponseService} performs the
 ...
 * {@code responses} table row; the source class name is retained — see docs/DECISION_LOG.md DL-025.
 *
 ...
 * {@code {"responses":[],"pagination":{"page":1,"per_page":10,"total":0,"total_pages":0}}}.
 *
