 ...
 *
 * <p>{@code isApproved} is a primitive and a {@code null} {@code id}, {@code content},
 * {@code generatedAt} or {@code tweetId} is rejected, so no component accepts {@code null}.
 *
...
public record ResponseDto(
    ...
    /**
     * Rejects a null value for each required reference component.
     *
     * @throws NullPointerException if {@code id}, {@code content}, {@code generatedAt} or
     *                             {@code tweetId} is null
     */
    public ResponseDto {
